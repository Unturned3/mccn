...
# data loader for training a large model (resnet, mobilenet, etc.)
...
# data loader for model distillation
...
# load images from UTKFace directory
def get_images(parent_path, age_thresh=(6, 18, 25, 35, 60), valid_percent=0.2, resize_shape=(32, 32)):
    ...
    for img_file in tqdm(img_files):
        ...
        age = int(os.path.splitext(os.path.basename(img_file))[0].split('_')[0])	# get age from file name prefix
